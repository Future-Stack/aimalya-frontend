...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen w-full relative content-center flex items-center justify-center overflow-hidden bg-[#E0F2FE]">
            ...
            {/* Login Card */}
            <div className="relative z-10 w-full max-w-[480px] bg-white/60 backdrop-blur-xl rounded-[30px] p-8 md:p-12 shadow-xl border border-white/50 space-y-8">
                <div className="text-center space-y-2">
                    <h1 className="text-[32px] font-bold text-[#1A1A1A]">Welcome Back</h1>
                    <p className="text-[#0066FF] font-medium text-[15px]">Please login to your account</p>
                </div>
                ...
                <form className="space-y-5">
                    ...
                    <div className="flex justify-end">
                        <Link
                            ...
                            className="text-[13px] font-bold text-[#FF5B5B] hover:text-[#E04F4F] transition-colors"
                        >
                            Forgot password?
                        </Link>
                    </div>
                ...
                <button className="w-full h-12 bg-white border border-zinc-100/80 text-zinc-700 rounded-xl font-bold text-[15px] hover:bg-zinc-50 transition-all shadow-sm flex items-center justify-center gap-2.5">
