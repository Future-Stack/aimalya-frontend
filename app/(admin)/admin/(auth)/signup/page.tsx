    ...
    return (
        <AuthLayout title="Admin Portal" subtitle="ReviewIQ Management System">
            <form className="space-y-4">
                <div>
                    <label className="block text-blue-200/80 text-sm mb-1.5 ml-1" htmlFor="name">
                        Name
                    </label>
                ...
                <div>
                    <label className="block text-blue-200/80 text-sm mb-1.5 ml-1" htmlFor="email">
                        Email
                    </label>
                    <div className="relative group">
                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-blue-300/50 group-focus-within:text-blue-400 transition-colors">
                ...
                <div>
                    <label className="block text-blue-200/80 text-sm mb-1.5 ml-1" htmlFor="password">
                        Password
                    </label>
                    <div className="relative group">
                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-blue-300/50 group-focus-within:text-blue-400 transition-colors">
                ...
                <div>
                    <label className="block text-blue-200/80 text-sm mb-1.5 ml-1" htmlFor="confirm-password">
                        Confirm Password
                    </label>
                    <div className="relative group">
                        <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-blue-300/50 group-focus-within:text-blue-400 transition-colors">
